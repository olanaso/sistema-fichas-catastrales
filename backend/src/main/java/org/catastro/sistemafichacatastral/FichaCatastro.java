...
public class FichaCatastro {
    ...
    private List<FichaCatastroUnidadUso> listFichacatastroEpsUniduso;
    ...
    public List<FichaCatastroUnidadUso> getListFichacatastroEpsUniduso() {
        return listFichacatastroEpsUniduso;
    }

    public void setListFichacatastroEpsUniduso(List<FichaCatastroUnidadUso> listFichacatastroEpsUniduso) {
        this.listFichacatastroEpsUniduso = listFichacatastroEpsUniduso;
    }
}
