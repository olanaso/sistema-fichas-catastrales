...
@Service
public class FichaCatastralMovilV2ServiceImpl implements FichaCatastralMovilV2Service {
  ...
  public int registraFichaV2(FichaCatastralMovil2Request fichaCatastralMovilRequest) {
	  String detalleRegistro = "";
	    String barridoRegistro = "";
	    String barridoRegistroF= "";
	    String validaRegistro="";
	
    String lectUtlima= ((FichaCatrastralMovilV2Individual_old)fichaCatastralMovilRequest.getListaFichaCatastroMovilV2().get(0)).getLecturaultima();
   
    
    if (lectUtlima == "" ||lectUtlima == null) {
    	lectUtlima ="0";
    } else {
    	lectUtlima = ((FichaCatrastralMovilV2Individual_old)fichaCatastralMovilRequest.getListaFichaCatastroMovilV2().get(0)).getLecturaultima();
    } 
 
    //`
    //nrocalle.replaceAll("'", ""); fichacatastro_eps nuevo --> antigiuo -->detfichacatastro_app
    
    try {
        this.jdbcTemplate.execute("select * from dbo.fichacatastro_eps");
      
        for (FichaCatrastralMovilV2Individual_old fichaCatrastralMovilIndividual : fichaCatastralMovilRequest.getListaFichaCatastroMovilV2()) {
        ...
        barridoRegistro = String.valueOf(barridoRegistro) + "exec dbo.usp_app_barridoCatastro  @CODEMPRE= '" + ((FichaCatrastralMovilV2Individual_old)fichaCatastralMovilRequest.getListaFichaCatastroMovilV2().get(0)).getCodemp()   + "'," + 
                " @CODSEDE= '" + ((FichaCatrastralMovilV2Individual_old)fichaCatastralMovilRequest.getListaFichaCatastroMovilV2().get(0)).getCodsede() + "'," + 
                " @CODINSPECTOR= '" + ((FichaCatrastralMovilV2Individual_old)fichaCatastralMovilRequest.getListaFichaCatastroMovilV2().get(0)).getCodinspector()   + "'";
