...
import {getSensorRemotos} from "../api"
...
const Listado = () => {
    ...
    useEffect(() => {
        async function init() {
            try {
                let result = await getSensorRemotos()
                setList(result)
            } catch (err) {
...
//Funcion de la busqueda
    const handleSerch = async (e) => {
        ...
        try {
            ...
            let result = await getSensorRemotos(query, {})
            setList(result)
    ...
    return (
        <>
            <FormsWrapper title="Configuración">
                    ...
                    <RowForm className="mb-3">
                        ...
                        <Col sm={12}>
                            <Link
                                ...
                                to={{
                                    pathname: `${Paths.config_sensor_remoto_add}`,
                ...
                <TitleForm>Listado de los Sensores Remotos</TitleForm>
