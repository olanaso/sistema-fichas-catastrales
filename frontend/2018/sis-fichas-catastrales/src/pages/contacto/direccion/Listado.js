...
import {getDirecciones} from "../api"
...
const Listado = () => {
    ...
    useEffect(() => {
        async function init() {
            try {
                let result = await getDirecciones()
                console.log(result)
                setList(result)
            } catch (err) {
...
//Funcion de la busqueda
    const handleSerch = async (e) => {
        ...
        try {
            ...
            let result = await getDirecciones(query, {})
            setList(result)
    ...
    return (
        <>
            <FormsWrapper title="Contactos">
                    ...
                    <RowForm className="mb-3">
                        <Col sm={12}>
                            <Link
                                ...
                                to={{
                                    pathname: `${Paths.contacto_direccion_add}`,
                ...
                <TitleForm>Listado de Direcciones</TitleForm>
