  ...
  return (
    <div className='container-section'>
      <div className="container-header">
        <span>Enviar Resultados de emergencia a Entidades</span>
      </div>
      <div className="register-container register-container--send">
        <p>Datos de la Emergencia</p>
        <InputGroup type='number' name='datoemergencia' label='Código de la Emergencia' placeholder='Ejm: 235656' button={{ name: 'Buscar', type: 'add' }} required />
        ...
        <Select2 required name='insti' id='basic-type' label='Institución' options={[ 'Connida', 'MIT', 'UNSCH' ]} />
        ...
        <InputGroup name='otroscorreos' label='Otros correos (Separado por comas)' placeholder='lmeza@conida.gob.pe, cpasapera@conida.gob.pe' />
      </div>
