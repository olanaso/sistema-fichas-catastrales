...
import {getEstadoConfiguracion} from "../api"
...
const Listado = () => {
    ...
    useEffect(() => {
        async function init() {
            try {
                let result = await getEstadoConfiguracion()
                setList(result)
            } catch (err) {
...
//Funcion de la busqueda
    const handleSerch = async (e) => {
        ...
        try {
            ...
            let result = await getEstadoConfiguracion(query, {})
            setList(result)
    ...
    return (
        <>
            <FormsWrapper title="Configuración">
                    ...
                    <RowForm className="mb-3">
                        <Col sm={12}>
                            <Link
                                ...
                                to={{
                                    pathname: `${Paths.config_estado_config_add}`,
                ...
                <TitleForm>Listado de Estado COF</TitleForm>
