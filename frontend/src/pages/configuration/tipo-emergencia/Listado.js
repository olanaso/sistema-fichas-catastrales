...
import {getTipoemergencia} from "../api"
...
const Listado = () => {
    ...
    useEffect(() => {
        async function init() {
            try {
                let result = await getTipoemergencia()
                setList(result)
            } catch (err) {
...
//Funcion de la busqueda
    const handleSerch = async (e) => {
        ...
        try {
            ...
            let result = await getTipoemergencia(query, {})
            setList(result)
    ...
    return (
        <>
            <FormsWrapper title="Configuración">
                    ...
                    <RowForm className="mb-3">
                        ...
                        <Col sm={12}>
                            <Link
                                ...
                                to={{
                                    pathname: `${Paths.config_tipo_emergencia_add}`,
                ...
                <TitleForm>Listado de los tipos de emergencia de INDECI</TitleForm>
