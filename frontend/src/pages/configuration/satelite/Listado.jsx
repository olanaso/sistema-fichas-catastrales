...
//Funcion de la busqueda
    const handleSerch = async (e) => {
        ...
        try {
            ...
            let result = await getSatelites(query, {})
            setList(result)
    ...
    let columns = [
        ...
        {label: "Nº", key: "id"},
        {label: "Satelite", key: "satelite"},
        {label: "noradid ", key: "noradid "},
    ...
    return (
        <>
            <FormsWrapper title="Configuración">
                    ...
                    <RowForm className="mb-3">
                        <Col sm={12}>
                            <Link
                                ...
                                to={{
                                    pathname: `${Paths.config_satelite_add}`,
                ...
                <TitleForm>Listado de Satelites</TitleForm>
