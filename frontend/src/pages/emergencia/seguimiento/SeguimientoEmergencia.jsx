...
const SeguimientoEmergencia = () => {
    ...
    return (<>
            <FormsWrapper title="Seguimiento de la Emergencia">
                    ...
                    <Row className="mb-3">
                        ...
                        <Col sm={6}>
                            <section className='container-resume'>
                                ...
                                <h6>COF</h6>
                                <InputGroup name='nropedido' label='N° pedido COF'
                                            button={{icon: 'sync', className: 'btn-zoom'}} placeholder='A-23351-1'/>
                                <Select name='estadocof' label='Estado en el COF'/>
                                <div>
                                    <strong>¿Descargado?</strong>
                                    <Switch name='descargado' label='Descargado'/>
                                </div>
                                <InputGroup name='urlarchivo' label='URL del archivo ó'
                                            placeholder='https://drive.google.com/Ur5E333D'/>
                                <span>
...
export default SeguimientoEmergencia;