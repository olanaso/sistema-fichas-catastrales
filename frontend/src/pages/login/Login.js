        ...
        <>
            <LoginWrapper>
                <Form className="form" onSubmit={handleSubmit}>
                    ...
                    <Form.Control size="sm" type="text" placeholder="Ingrese el usuario" required value={user.usuario}
                                  name={"usuario"} onChange={handleInputChange}/>
                    <Form.Label>Contraseña</Form.Label>
                    <Form.Control size="sm" type="password" placeholder="Ingrese la contraseña" required
                                  value={user.contrasena} name={"contrasena"} onChange={handleInputChange}/>
