...
export const CustomInputControlled = forwardRef<
  HTMLInputElement,
  CustomInputProps
>(
  (
    ...
    const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      // Llamar al onChange externo con el valor modificado
      if (onChange) {
    ...
    const hasError = error || (type === "email" && !isValid && value !== "");
    ...
    return (
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          {helperText && String(value).length == 0 && (
