...
import { Circle, Hash, Building } from "lucide-react"
import { TipoConstruccion } from "@/models/tipos"

export const columnsTipoConstruccion: ColumnDef<TipoConstruccion>[] = [
  {
    id: "index",
    header: "N°",
    cell: ({ row }) => {
