...
import { Calendar, Circle, Hash, FileText } from "lucide-react"
import { TipoServicio } from "@/models/tipos"

export const columnsTipoServicio: ColumnDef<TipoServicio>[] = [
  {
    id: "index",
    header: "N°",
    cell: ({ row }) => {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const abrev = row.original.abrev;
      return (
