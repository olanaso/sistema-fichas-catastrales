...
import { TipoSituacionConexion } from "@/models/tipos"

export const columnsTipoSituacionConexion: ColumnDef<TipoSituacionConexion>[] = [
  {
    id: "index",
    header: "N°",
    cell: ({ row }) => {
  ...
  {
    id: "situacionconexion",
    accessorKey: "situacionconexion",
    header: ({ column }) => {
      return <TableHeaderColumn column={column} title="Situación Conexión" />
    },
  },
  {
    id: "descripcion",
