...
import { TipoEstadoConexion } from "@/models/tipos"

export const columnsTipoEstadoConexion: ColumnDef<TipoEstadoConexion>[] = [
  {
    id: "index",
    header: "N°",
    cell: ({ row }) => {
  ...
  {
    id: "estconexion",
    accessorKey: "estconexion",
    header: ({ column }) => {
      return <TableHeaderColumn column={column} title="Estado Conexión" />
    },
  },
  {
    id: "descripcion",
