...
import { Calendar, Circle, Shield, ShieldCheck } from "lucide-react"
import { CustomBadge } from "@/components/custom/custom-badge"
import { TipoCalle } from "@/models/tipos"

export const columnsTipoCalle: ColumnDef<TipoCalle>[] = [
  {
    id: "index",
    header: "N°",
    cell: ({ row }) => {
